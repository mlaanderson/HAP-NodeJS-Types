 ...
 * @property {Array} Characteristics - Required characteristics: Identify, Manufacturer, Model, Name, SerialNumber.
 * @property {Array} OptionalCharacteristics - Optional characteristics: FirmwareRevision, HardwareRevision, SoftwareRevision.
 ...
 * @property {Array} Characteristics - Required characteristics: AirQuality.
 * @property {Array} OptionalCharacteristics - Optional characteristics: AirParticulateDensity, AirParticulateSize, StatusActive, StatusFault, StatusTampered, StatusLowBattery, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: BatteryLevel, ChargingState, StatusLowBattery.
 * @property {Array} OptionalCharacteristics - Optional characteristics: Name.
 ...
 * @property {Array} Characteristics - Required characteristics: Reachable, LinkQuality, AccessoryIdentifier, Category.
 * @property {Array} OptionalCharacteristics - Optional characteristics: Name.
 ...
 * @property {Array} Characteristics - Required characteristics: CarbonDioxideDetected.
 * @property {Array} OptionalCharacteristics - Optional characteristics: StatusActive, StatusFault, StatusLowBattery, StatusTampered, CarbonDioxideLevel, CarbonDioxidePeakLevel, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: CarbonMonoxideDetected.
 * @property {Array} OptionalCharacteristics - Optional characteristics: StatusActive, StatusFault, StatusLowBattery, StatusTampered, CarbonMonoxideLevel, CarbonMonoxidePeakLevel, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: ContactSensorState.
 * @property {Array} OptionalCharacteristics - Optional characteristics: StatusActive, StatusFault, StatusTampered, StatusLowBattery, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: CurrentPosition, PositionState, TargetPosition.
 * @property {Array} OptionalCharacteristics - Optional characteristics: HoldPosition, ObstructionDetected, Name.
...
/**
 * @summary Service "Fan".
 * @property {Array} Characteristics - Required characteristics: On.
 * @property {Array} OptionalCharacteristics - Optional characteristics: RotationDirection, RotationSpeed, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: CurrentDoorState, TargetDoorState, ObstructionDetected.
 * @property {Array} OptionalCharacteristics - Optional characteristics: LockCurrentState, LockTargetState, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: CurrentRelativeHumidity.
 * @property {Array} OptionalCharacteristics - Optional characteristics: StatusActive, StatusFault, StatusTampered, StatusLowBattery, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: LeakDetected.
 * @property {Array} OptionalCharacteristics - Optional characteristics: StatusActive, StatusFault, StatusTampered, StatusLowBattery, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: CurrentAmbientLightLevel.
 * @property {Array} OptionalCharacteristics - Optional characteristics: StatusActive, StatusFault, StatusTampered, StatusLowBattery, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: On.
 * @property {Array} OptionalCharacteristics - Optional characteristics: Brightness, Hue, Saturation, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: LockControlPoint, Version.
 * @property {Array} OptionalCharacteristics - Optional characteristics: Logs, AudioFeedback, LockManagementAutoSecurityTimeout, AdministratorOnlyAccess, LockLastKnownAction, CurrentDoorState, MotionDetected, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: LockCurrentState, LockTargetState.
 * @property {Array} OptionalCharacteristics - Optional characteristics: Name.
 ...
 * @property {Array} Characteristics - Required characteristics: MotionDetected.
 * @property {Array} OptionalCharacteristics - Optional characteristics: StatusActive, StatusFault, StatusTampered, StatusLowBattery, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: OccupancyDetected.
 * @property {Array} OptionalCharacteristics - Optional characteristics: StatusActive, StatusFault, StatusTampered, StatusLowBattery, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: On, OutletInUse.
 * @property {Array} OptionalCharacteristics - Optional characteristics: Name.
 ...
 * @property {Array} Characteristics - Required characteristics: SecuritySystemCurrentState, SecuritySystemTargetState.
 * @property {Array} OptionalCharacteristics - Optional characteristics: StatusFault, StatusTampered, SecuritySystemAlarmType, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: SmokeDetected.
 * @property {Array} OptionalCharacteristics - Optional characteristics: StatusActive, StatusFault, StatusTampered, StatusLowBattery, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: ProgrammableSwitchEvent, ProgrammableSwitchOutputState.
 * @property {Array} OptionalCharacteristics - Optional characteristics: Name.
 ...
 * @property {Array} Characteristics - Required characteristics: ProgrammableSwitchEvent.
 * @property {Array} OptionalCharacteristics - Optional characteristics: Name.
 ...
 * @property {Array} Characteristics - Required characteristics: CurrentTemperature.
 * @property {Array} OptionalCharacteristics - Optional characteristics: StatusActive, StatusFault, StatusLowBattery, StatusTampered, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: CurrentHeatingCoolingState, TargetHeatingCoolingState, CurrentTemperature, TargetTemperature, TemperatureDisplayUnits.
 * @property {Array} OptionalCharacteristics - Optional characteristics: CurrentRelativeHumidity, TargetRelativeHumidity, CoolingThresholdTemperature, HeatingThresholdTemperature, Name.
 ...
 * @property {Array} Characteristics - Required characteristics: CurrentTime, DayoftheWeek, TimeUpdate.
 ...
 * @property {Array} Characteristics - Required characteristics: Name, AccessoryIdentifier, TunneledAccessoryStateNumber, TunneledAccessoryConnected, TunneledAccessoryAdvertising, TunnelConnectionTimeout.
 ...
 * @property {Array} Characteristics - Required characteristics: CurrentPosition, TargetPosition, PositionState.
 * @property {Array} OptionalCharacteristics - Optional characteristics: HoldPosition, TargetHorizontalTiltAngle, TargetVerticalTiltAngle, CurrentHorizontalTiltAngle, CurrentVerticalTiltAngle, ObstructionDetected, Name.
